...
dict1 = {"第一个球": 1, "第二个球": 7, "第三个球": 12, "第四个球": 14,
         "第五个球": 15, "第六个球": 28, "第七个球": 10}
...
str1 = '13487280000'
lst = list(str1)
print(lst, type(lst))  # ['1', '3', '4', '8', '7', '2', '8', '0', '0', '0', '0']

# 字符串转集合,因为set集合不能重复，所以相同的元素会被过滤掉
str1 = '13487280000'
set_number = set(str1)
print(set_number)  # {'8', '3', '1', '4', '2', '0', '7'}

# (8) del() 删除，该函数可以删除任意数据
nick_name = 'xiaohua'
print(nick_name)  # xiaohua
del nick_name
# print(nick_name)  # name 'nick_name' is not defined
list1 = [1, 2, 3, 54]
del list1[-1]
print(list1)  # [1, 2, 3]

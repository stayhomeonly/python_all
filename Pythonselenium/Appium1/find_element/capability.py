...
def check_myself():
    ...
    try:
        button_self = driver.find_element(By.ID,'com.tal.kaoyan:id/mainactivity_button_mysefl')
    except NoSuchElementException:
        print('no button_self')
    else:
        button_self.click()
...
def check_notlogin():
    print('check notlogin')
    try:
        notlogin = driver.find_element(By.ID,'com.tal.kaoyan:id/activity_usercenter_userheader')
    except NoSuchElementException:
        print('no notlogin')
